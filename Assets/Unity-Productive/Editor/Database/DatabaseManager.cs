...
public class DatabaseManager : RenderGroup
{
	...
	public DatabaseManager(EditorWindow window)
	{
		...
		background = (Quad)AddRenderObject("Background", new Quad());
		openDatabaseButton = (Button)AddRenderObject("Open Database Button", new Button("Open Database"));
		createDatabaseButton = (Button)AddRenderObject("Create Database Button", new Button("Create Database Button"));
